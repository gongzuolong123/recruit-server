...
require_once APPLICATION_DIRECTORY . '/library/aliyunsdk/dysms-api/vendor/autoload.php';
...
class SmsSend {
  ...
  public static function getAcsClient() {
    ...
    $accessKeyId = "LTAIXO9U1itZu4gz"; // AccessKeyId

    $accessKeySecret = "x3NvvvZqeDXabQRdSC5gclHvchg8n0"; // AccessKeySecret
  ...
  public static function sendSms($phone, $code) {
    ...
    $request->setSignName("一刻直聘");

    // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
    $request->setTemplateCode("SMS_142595028");
